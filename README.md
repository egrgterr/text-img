...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/text-img
```

A live public deployment of this template is available at [https://text-img.templates.workers.dev](https://text-img.templates.workers.dev)
